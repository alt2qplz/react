    ...
    return <>
        {props.victory
            ...
            : <div className={cn(s.gameRules)}>
                ...
                <br/>
                <p>
                    Компьютер задумывает четыре различные цифры из <span>0,1,2,...9</span>.<br/>Игрок делает ходы, чтобы
                    узнать
                    эти цифры и их порядок.
                    <br/><br/>
                    Каждый ход состоит из четырёх цифр, 0 может стоять на первом месте.
                    <br/><br/>
                    В ответ компьютер показывает число отгаданных цифр, стоящих на своих местах (число быков) и число
                    отгаданных
    ...
    return (
        <div className={cn(s.game)}>
            ...
            <div className={cn(s.currentResult)}>
                <div>
                    <img src="https://metaschool.ru/pub/games/bulls-and-cows/img/bull-2.png" alt=""
                         className={cn(s.bull)}/>
                    <p>
                        {props.bulls}
                    </p>
